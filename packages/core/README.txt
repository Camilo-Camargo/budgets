...
a persistence unit "budgetsPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "budgets/pom.xml":
...
artifacts ("budgets-ejb.jar" and "budgets-web.war") are already built. You can build
